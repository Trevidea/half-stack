...
export class AccountViewRange implements Views.Datasource {
    ...
    private _account: Collection<AccountView>;
    public get account(): Collection<AccountView> {
        if (!this._account) {
            this._account = new Collection<AccountView>();
        }
        return this._account;
    }
    public set account(v: Collection<AccountView>) {
        this._account = v;
    }
}
