...
export class AppLandingpageComponent {
  ...
  demos: demos[] = [
    {
      ...
      name: 'Main',
      subtext: 'Demo',
      url: 'https://flexy-angular-main.netlify.app/dashboards/dashboard1',
    },
    {
      id: 2,
      ...
      name: 'Dark',
      subtext: 'Demo',
      url: 'https://flexy-angular-dark.netlify.app/dashboards/dashboard2',
    },
    {
      id: 5,
      ...
      name: 'Horizontal',
      subtext: 'Demo',
      url: 'https://flexy-angular-horizontal.netlify.app/dashboards/dashboard3',
    },
    {
      id: 3,
      ...
      name: 'RTL',
      subtext: 'Demo',
      url: 'https://flexy-angular-rtl.netlify.app/dashboards/dashboard1',
    },
    {
      id: 4,
      ...
      name: 'Minisidebar',
      subtext: 'Demo',
      url: 'https://flexy-angular-minisidebar.netlify.app/dashboards/dashboard2',
    },
    {
      id: 5,
      ...
      name: 'Authguard',
      subtext: 'Demo',
      url: 'https://flexy-angular-authguard.netlify.app/authentication/login',
    },
  ];
  ...
  appdemos: demos[] = [
    {
      ...
      name: 'Calendar',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/calendar',
    },
    {
      id: 2,
      ...
      name: 'Chat',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/chat',
    },
    {
      id: 3,
      ...
      name: 'Contact',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/contacts',
    },
    {
      id: 4,
      ...
      name: 'Email',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/email/inbox',
    },
    {
      id: 5,
      ...
      name: 'Courses',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/courses',
    },
    {
      id: 6,
      ...
      name: 'Employee',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/employee',
    },
    {
      id: 7,
      ...
      name: 'Notes',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/notes',
    },
    {
      id: 8,
      ...
      name: 'Tickets',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/tickets',
    },
    {
      id: 9,
      ...
      name: 'Invoice',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/invoice',
    },
    {
      id: 10,
      ...
      name: 'Todo',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/todo',
    },
    {
      id: 11,
      ...
      name: 'Taskboard',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/taskboard',
    },
    {
      id: 12,
      ...
      name: 'Blog List',
      subtext: 'Application',
      url: 'https://flexy-angular-main.netlify.app/apps/blog/post',
    },
  ];
  ...
  features: features[] = [
    ...
    },
    {
      ...
      color: 'error',
      subtext: 'Almost 50+ UI Components being given with Flexy Admin Pack.',
    },
    {
      id: 5,
      icon: 'tag',
