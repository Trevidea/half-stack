...
export const menu: CoreMenu[] = [
  // User Interface
  {
    ...
    type: 'section',
    title: '',
    translate: 'MENU.SPORTPIPCAPTURE.SECTION',
    icon: 'layers',
    children: [
      {
        id: 'capture-dashboard',
        title: 'Dashboard',
        translate: 'MENU.SPORTPIPCAPTURE.CAPTUREDASHBOARD',
        type: 'item',
        icon: 'home',
        url: 'capture-dashboard'
      },
      {
        id: 'event',
        title: 'Events',
        translate: 'MENU.SPORTPIPCAPTURE.EVENT',
        type: 'item',
        icon: 'calendar',
        url: 'event'
      },
      {
        id: 'connection',
        title: 'Connection',
        translate: 'MENU.SPORTPIPCAPTURE.CONNECTION',
        type: 'item',
        icon: 'link',
        url: 'connection'
      },
      {
        id: 'logs',
        title: 'Logs',
        translate: 'MENU.SPORTPIPCAPTURE.LOGS',
        type: 'item',
        icon: 'activity',
        url: 'logs'
      },
      {
        id: 'shared',
        title: 'Shared',
        translate: 'MENU.SPORTPIPCAPTURE.SHARED',
        type: 'item',
        icon: 'share-2',
        url: 'shared'
      },
      ...
      },
      {
        id: 'metatypes',
        title: 'Meta-Types',
        translate: 'MENU.SPORTPIPCAPTURE.METATYPES',
        type: 'item',
        icon: 'framer',
        url: 'meta-types'
      },
  ...
  //   id: 'dashboard',
  //   title: 'Dashboard',
  //   translate: 'MENU.DASHBOARDS.COLLAPSIBLE',
  //   type: 'collapsible',
  //   // role: ['Admin'], //? To hide collapsible based on user role
  //   icon: 'home',
  //   badge: {
  //     title: '2',
  //     translate: 'MENU.DASHBOARDS.BADGE',
  ...
  //       id: 'ecommerce',
  //       title: 'eCommerce',
  //       translate: 'MENU.DASHBOARDS.ECOMMERCE',
  //       type: 'item',
  //       icon: 'circle',
