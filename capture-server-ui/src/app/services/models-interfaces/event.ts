...
export class EventData extends DataBase<Data.Event>{
    ...
    public get assets() : Data.Assets {
        return this._model.assets;
    }
    public set assets(v : Data.Assets) {
        this._model.assets = v;
    }
    
    public get sharing() : Data.Sharing {
        return this._model.sharing;
    }
    public set sharing(v : Data.Sharing) {
        this._model.sharing = v;
