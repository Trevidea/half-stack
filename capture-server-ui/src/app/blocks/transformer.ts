...
export class Transformer {
  ...
  static Serialize<M, V, T extends AbstractBuilder<M, V>>(view: V, serializer: { (model: M): Observable<M> },
    builder: new () => T, response: { (through: boolean, data: M, err: any): void } = null): SerializerStrategy<M, V, T> {
