...
const routes: Routes = [
  ...
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "team", component: TeamPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "coaches", component: CoachPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "player", component: PlayerPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "roster", component: RosterPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "media", component: MediaPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "analysis", component: AnalysisPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "tagging", component: TaggingPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "setup", component: SetupPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "notification", component: NotificationPresenter }],
  },
  {
    path: "",
    component: SportPipPresenter,
    children: [{ path: "settings", component: SettingPresenter }],
  },
  {
    path: "",
    redirectTo: "/home",
