...
const appRoutes: Routes = [
  {
    path: 'example',
    loadChildren: () => import('./sport-pip/example/example.module').then(m => m.ExampleModule),
    
  },
  {
    path: 'sport-pip-capture',
    loadChildren: () => import('./sport-pip-capture/sport-pip-capture.module').then(m => m.SportPipCaptureModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'sport-pip-capture-ui-setting',
    loadChildren: () => import('./sport-pip-capture/components/setting/setting.module').then(m => m.SettingModule)
  },
