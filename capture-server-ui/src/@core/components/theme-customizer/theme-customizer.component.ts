...
import { SharingPreferencesService } from '../../../app/blocks/sharing-preferences.service';
...
export class CoreThemeCustomizerComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private sharingPreferences:SharingPreferencesService
  ) {
  ...
  ngOnInit(): void {
    ...
    this.form
      ...
      // this.sharingPreferences.sharedData$.subscribe((data) => {
      
      //     this.form.patchValue({
      //       layout: {
      //         skin: data == null ?'default': data
      //       }
      //     })
